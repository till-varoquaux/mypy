...
if sys.version_info >= (3, 15):
    ...
    class AnnotatedType:
        ...
        @property
        def __parameters__(self) -> tuple[Any, ...]: ...
        def __new__(cls, origin: type, metadata: Any, /) -> Self: ...
        def __getitem__(self, typeargs: Any, /) -> AnnotatedType: ...
        def __eq__(self, value: object, /) -> bool: ...
        def __hash__(self) -> int: ...
        def __matmul__(self, other: Any, /) -> AnnotatedType: ...
